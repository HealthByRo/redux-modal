  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          closeTimeoutMS = _props3.closeTimeoutMS,
          otherProps = _objectWithoutProperties(_props3, ['className', 'closeOnBackgroundClick', 'component', 'contentLabel', 'onClose', 'onOpen', 'overlayClassName', 'closeTimeoutMS']);
